                ...
                {state === "success" ? (
                  <div className="mt-6">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {item.status === "soon"
                        ? "Je staat op de lijst. Zodra de PDF klaar is krijg je hem in je mailbox."
                        : "Check je inbox - we sturen de PDF nu naar je toe. Niets ontvangen? Check ook je spam-map."}
                    </p>
                  </div>
                ) : item.status === "soon" ? (
                  <div className="mt-6">

...
const sections = [
  {
    ...
    items: [
      ...
      { icon: MapPin, title: "Lokale SEO", href: "/diensten/lokale-seo", description: "Word gevonden op Google in jouw werkgebied — zonder advertenties." },

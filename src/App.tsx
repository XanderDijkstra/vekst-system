...
import FakturaprogramForHandverkere from "./pages/vergelijk/FakturaprogramForHandverkere";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/sammenlign/fakturaprogram-for-handverkere" element={<FakturaprogramForHandverkere />} />

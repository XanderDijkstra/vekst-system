...
const BlogOverview = () => (
  <PageShell>
    <Helmet>
      <title>Tips & Tricks | Aannemer Systeem</title>
      <meta name="description" content="Praktische tips over marketing, automatisering en meer klanten binnenhalen als aannemer." />
      <link rel="canonical" href={`${SITE_URL}/blog`} />
      <meta property="og:title" content="Tips & Tricks | Aannemer Systeem" />
      <meta property="og:description" content="Praktische tips over marketing, automatisering en meer klanten binnenhalen als aannemer." />
    ...
    <section className="py-20 md:py-28 bg-primary">
      <div className="container">
        <motion.p {...fadeInUp} className="text-xs font-bold uppercase tracking-widest text-accent mb-4">Blog</motion.p>
        <motion.h1 {...fadeInUp} className="text-4xl md:text-5xl font-bold tracking-tight text-primary-foreground">Tips & Tricks</motion.h1>

...
export const ROLLUIKEN_ZONWERING_DATA: TradeData = {
  ...
  problems: {
    sectionTitle: "Herken je dit als rolluiken & zonwering bedrijf?",
    items: [
      { title: "Seizoensafhankelijkheid maakt plannen lastig", description: "In het voorjaar en de zomer stromen de aanvragen binnen voor screens en zonwering, maar in de winter is het stil. Zonder een constante online aanwezigheid die ook rolluiken, garagedeuren en reparaties promoot, blijf je afhankelijk van het weer." },
      { title: "Grote merken en webshops domineren online", description: "Merken als Somfy, Luxaflex en grote webshops investeren miljoenen in online zichtbaarheid. Als lokaal montagebedrijf word je weggedrukt in de zoekresultaten, terwijl jij juist de specialist bent die vakkundig op maat monteert." },
      { title: "Geen tijd voor marketing naast de montages", description: "Je dagen bestaan uit opmeten, monteren, repareren en klanten adviseren. Na een volle werkdag heb je geen energie om met een website, SEO of social media bezig te zijn." },
      { title: "Klanten vergelijken online prijzen zonder context", description: "Klanten zien goedkope zonwering op webshops en begrijpen niet waarom jouw op-maat-oplossing meer kost. Zonder goede online content die het verschil uitlegt tussen standaard en maatwerk, verlies je opdrachten aan goedkope aanbieders." },
    ],
  },
  solution: {
    ...
    items: [
      ...
      { title: "Automatische reviews die vertrouwen opbouwen", description: "Na elke montage sturen wij automatisch een reviewverzoek naar je klant. Tevreden? Direct naar Google. Niet tevreden? Eerst naar jou. Zo bouw je een reviewprofiel op dat laat zien dat jij dé zonwering specialist bent in jouw regio.", keywords: ["google reviews", "online reputatie", "zonwering specialist", "5 sterren"] },
      { title: "Gemiste oproep? Direct een automatisch bericht terug", description: "Bezig met het monteren van screens op een steiger en kun je niet opnemen? Wij sturen automatisch een SMS: 'Bedankt voor je telefoontje, ik neem zo snel mogelijk contact op.' Zo verlies je nooit een potentiële klant.", keywords: ["lead opvolging", "gemiste oproepen", "sms automatisering", "klantbehoud"] },
    ],
  },
  industryContent: {
  ...
  results: {
    sectionTitle: "Resultaten voor rolluiken & zonwering bedrijven",
    items: [
      { metric: "Van 5 naar 62 Google reviews", description: "In 6 maanden, volledig automatisch na elke montage en reparatie" },
      { metric: "Pagina 1 in Google Maps", description: "Voor 'zonwering specialist [stad]' binnen 3 maanden" },
  ...
  cta: {
    headline: "Klaar om meer zonwering opdrachten binnen te halen?",
    subheadline: "Boek een gratis gesprek en we laten zien hoe het systeem werkt voor rolluiken & zonwering bedrijven in jouw regio.",

...
export const AANNEMERS_DATA: TradeData = {
  ...
  problems: {
    sectionTitle: "Herken je dit als aannemer?",
    items: [
      { title: "Te afhankelijk van mond-tot-mond", description: "Jarenlang leefde je van aanbevelingen, maar de stroom droogt op. Nieuwe bouwprojecten gaan naar aannemers die wél online zichtbaar zijn. Zonder website en Google-profiel mis je opdrachten die je anders moeiteloos had binnengehaald." },
      { title: "Concurrentie van grote bouwbedrijven", description: "Grote aannemers met marketingbudgetten domineren de zoekresultaten. Op Werkspot concurreer je op prijs met tientallen andere partijen. Jouw vakmanschap en betrouwbaarheid komen niet over in een rijtje offertes." },
      { title: "Geen tijd voor marketing naast de bouwprojecten", description: "Je staat elke dag op de bouwplaats. Na een dag sjouwen, coördineren en problemen oplossen heb je geen energie meer om aan je website of social media te werken. Marketing voelt als een tweede baan." },
      { title: "Klanten twijfelen zonder online bewijs", description: "Potentiële opdrachtgevers willen foto's van eerdere projecten, reviews van tevreden klanten en een professionele website zien. Zonder dit kiest men voor de concurrent die dit wél op orde heeft." },
    ],
  },
  solution: {
    ...
    items: [
      ...
      { title: "Automatische reviews die vertrouwen opbouwen", description: "Na elke oplevering sturen wij automatisch een reviewverzoek naar je opdrachtgever. Tevreden? Direct naar Google. Niet tevreden? Eerst naar jou. Zo bouw je een reviewprofiel op dat laat zien dat jij de betrouwbare aannemer bent waar klanten op kunnen rekenen.", keywords: ["google reviews", "online reputatie", "betrouwbare aannemer", "5 sterren"] },
      { title: "Gemiste oproep? Direct een automatisch bericht terug", description: "Sta je op de bouwplaats en kun je niet opnemen? Wij sturen automatisch een SMS: 'Bedankt voor je telefoontje, ik neem zo snel mogelijk contact op.' Zo verlies je nooit een potentiële opdrachtgever.", keywords: ["lead opvolging", "gemiste oproepen", "sms automatisering", "klantbehoud"] },
    ],
  },
  industryContent: {
  ...
  results: {
    sectionTitle: "Resultaten voor aannemers",
    items: [
      { metric: "Van 4 naar 89 Google reviews", description: "In 8 maanden, volledig automatisch na elke projectoplevering" },
      { metric: "Pagina 1 in Google Maps", description: "Voor 'aannemer [stad]' binnen 3 maanden" },
  ...
  cta: {
    headline: "Klaar om meer bouwprojecten binnen te halen?",
    subheadline: "Boek een gratis gesprek en we laten zien hoe het systeem werkt voor aannemers in jouw regio.",

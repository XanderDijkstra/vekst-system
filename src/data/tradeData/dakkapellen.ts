...
export const DAKKAPELLEN_DATA: TradeData = {
  ...
  hero: {
    ...
    stats: [
      ...
      { value: "€8.500+", label: "gemiddelde opdrachtwaarde per dakkapel" },
      { value: "7", label: "dagen en je nieuwe website staat live" },
    ],
  },
  problems: {
    sectionTitle: "Herken je dit als dakkapel specialist?",
    items: [
      { title: "Grote landelijke spelers domineren Google", description: "Partijen als Dakkapel.nl, Van Wanrooij en De Dakkapelspecialist geven duizenden euro's per maand uit aan Google Ads. Als lokaal specialist word je weggedrukt, terwijl jij vaak sneller kunt leveren en persoonlijk advies biedt." },
      { title: "Vergelijkingssites eten je marge op", description: "Platforms als Offerteadviseur en Solvari sturen dezelfde lead door naar 3 tot 5 dakkapelbedrijven. Je concurreert alleen op prijs, terwijl kwaliteit, plaatsingstijd en afwerking juist het verschil maken." },
      { title: "Lange beslissingstijd vereist vertrouwen", description: "Een dakkapel is een investering van €8.000 tot €20.000. Klanten oriënteren zich wekenlang en vergelijken meerdere aanbieders. Zonder sterke online aanwezigheid met reviews en portfolio val je al af voordat je kunt offreren." },
      { title: "Seizoenspatroon zorgt voor onzekerheid", description: "In het voorjaar en de zomer stroomt het werk binnen, maar in de winter valt de aanvraag stroom stil. Zonder eigen lead-generatie ben je afhankelijk van dure platforms als het rustig is." },
    ],
  },
  solution: {
    ...
    items: [
      ...
      { title: "Automatische reviews na elke dakkapel plaatsing", description: "Na oplevering sturen wij automatisch een reviewverzoek naar je klant. Tevreden? Direct naar Google. Niet tevreden? Eerst naar jou. Zo bouw je een reviewprofiel op dat laat zien dat jij de betrouwbare dakkapel specialist bent in jouw regio.", keywords: ["google reviews", "online reputatie", "dakkapel reviews", "5 sterren"] },
      { title: "Gemiste oproep? Direct een automatisch bericht terug", description: "Sta je op het dak bezig met een plaatsing en kun je niet opnemen? Wij sturen automatisch een SMS: 'Bedankt voor je telefoontje, ik neem zo snel mogelijk contact op.' Zo verlies je nooit een potentiële opdracht van €10.000+.", keywords: ["lead opvolging", "gemiste oproepen", "sms automatisering", "klantbehoud"] },
    ],
  },
  industryContent: {
    sectionTitle: "Marketing voor dakkapel specialisten: wat werkt in 2026?",
    paragraphs: [
  ...
  results: {
    sectionTitle: "Resultaten voor dakkapel specialisten",
    items: [
      { metric: "Van 5 naar 68 Google reviews", description: "In 6 maanden, volledig automatisch na elke dakkapel plaatsing" },
      { metric: "Pagina 1 in Google Maps", description: "Voor 'dakkapel specialist [stad]' binnen 3-4 maanden" },
  ...
  cta: {
    headline: "Klaar om meer dakkapel opdrachten binnen te halen?",
    subheadline: "Boek een gratis gesprek en we laten zien hoe het systeem werkt voor dakkapel specialisten in jouw regio.",

...
const systems = [
  {
    ...
    description: "Een website die nieuwe klanten aantrekt en offerte aanvragen automatisch verzamelt.",
    href: "/systemen/lead-generatie",
  },
  {
    icon: PhoneOff,
    title: "Gemiste Oproep → SMS",
    description: "Automatisch een bericht sturen wanneer je een oproep mist.",
    href: "/systemen/klantcommunicatie",
  },
  {
    icon: FileText,
    title: "Offerte Automatisering",
    description: "Maak offertes sneller en volg ze automatisch op.",
    href: "/systemen/offerte-systeem",
  },
  {
    icon: Star,
    title: "Review Systeem",
    description: "Verzamel automatisch Google reviews van tevreden klanten.",
    href: "/systemen/review-systeem",
  },
  {
    icon: BarChart3,
    title: "Marketing Automatisering",
    description: "Bereik je doelgroep automatisch met de juiste boodschap op het juiste moment.",
    href: "/systemen/marketing-automatisering",
  },
  {
    icon: Calendar,
    title: "Planning Systeem",
    description: "Beheer projecten en planning op één centrale plek.",
    href: "/systemen/planning-systeem",
  },
  {
    icon: FolderKanban,
    title: "Project Management",
    description: "Houd overzicht over al je projecten, taken en deadlines.",
    href: "/systemen/planning-systeem",
  },
  {
    icon: Plug,
    title: "Integraties & Automatisering",
    description: "Koppel je bestaande tools en laat ze naadloos samenwerken.",
    href: "/diensten/software-integraties",
  },
];
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {systems.map((system, i) => (
            ...
            >
              ...
              >
                <system.icon
                  className="h-6 w-6 text-muted-foreground group-hover:text-accent transition-colors duration-250 ease-system-ease"
                  strokeWidth={1.5}
                />

...
const STEPS: StepStripItem[] = [
  { step: 1, label: "Sendt",      sub: "SMS med direktelink", from: 0.3, to: 2.5 },
  { step: 2, label: "Åpnet",      sub: "Kunden vurderer",     from: 2.8, to: 6.8 },
  { step: 3, label: "5 stjerner", sub: "Skriver fritt",       from: 7.0, to: 9.5 },
  { step: 4, label: "Publisert",  sub: "Live på Google",      from: 9.8, to: 10.9 },
];

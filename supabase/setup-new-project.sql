-- ============================================
-- Aannemer Systeem - Database Setup
-- Run this in your new Supabase project's SQL Editor
-- ============================================

-- 1. Configurator Features table
CREATE TABLE public.configurator_features (
  ...
  project_price NUMERIC(10,2) NOT NULL DEFAULT 0,
...
CREATE POLICY "Anyone can update settings"
  ON public.configurator_settings FOR UPDATE
  TO anon, authenticated USING (true) WITH CHECK (true);

CREATE POLICY "Anyone can insert settings"
  ON public.configurator_settings FOR INSERT
